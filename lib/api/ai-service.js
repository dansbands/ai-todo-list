...
export const looksLikeStructuredOutput = (value) => {
...
export const getFallbackGuidance = ({ todoTitle = "", userMessage = "", rawContent = "" } = {}) => ({
  message:
...
export const normalizeGuidance = (payload, context = {}) => {
...
export const parseModelContent = (content, context) => {
...
export const buildPrompt = ({ todoTitle = "", userMessage = "" }) => {
...
export const getGuidance = async ({ todoTitle = "", userMessage = "" }) => {
